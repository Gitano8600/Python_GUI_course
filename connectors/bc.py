...
class BcConnector:
    def __init__(self, acct_data: typing.Dict):
        ...
        self._headers = {'apikey': acct_data['api-key']}
    ...
    def _make_request(self):
        ...
        try:
            response = requests.get(self._endpoint + self._parameters, headers=self._headers)
    ...
    def get_balances(self):
        ...
        for count, value in enumerate(response['data']):
            temp_balance += value['balance'] * 0.000000001 * wallets[count][1]

        balances['ETH2'] = Balance(['ETH2', temp_balance], "other")
